...
var _user$project$Routing$matchers = _evancz$url_parser$UrlParser$oneOf(
	{
		...
		_0: A2(
			...
			_user$project$Models$NewChatRoomRoute,
			A2(
		...
		_1: {
			...
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_user$project$Models$ChatRoomRoute,
				A2(
					_evancz$url_parser$UrlParser_ops['</>'],
					_evancz$url_parser$UrlParser$s('chat'),
					A2(
						...
						A2(
							_evancz$url_parser$UrlParser_ops['</>'],
							_evancz$url_parser$UrlParser$s('u'),
...
var _user$project$Routing$baseUrl = '/chat/index/';
var _user$project$Routing$newChatRoomPath = A2(_elm_lang$core$Basics_ops['++'], _user$project$Routing$baseUrl, 'new');
var _user$project$Routing$chatRoomPath = function (chatRoom) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_user$project$Routing$baseUrl,
...
var _user$project$View$invertedOr = F2(
	function (x, y) {
		return !(x || y);
	});
var _user$project$View$maybePreventDefault = F2(
...
var _user$project$View$preventDefault2 = A3(
	_elm_lang$core$Json_Decode$map2,
	_user$project$View$invertedOr,
...
var _user$project$View$onPreventDefaultClick = function (message) {
	return A3(
		_elm_lang$html$Html_Events$onWithOptions,
		'click',
		_elm_lang$core$Native_Utils.update(
		...
		A2(
			_elm_lang$core$Json_Decode$andThen,
			_user$project$View$maybePreventDefault(message),
			_user$project$View$preventDefault2));
};
var _user$project$View$onClickPage = function (route) {
	return {
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$href(
			_user$project$Routing$getUrl(route)),
		_1: {
			ctor: '::',
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$alt('50x50'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('media-object img-rounded'),
								_1: {
									ctor: '::',
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('media-body'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$h4,
								{
									...
									_1: {
										ctor: '::',
										_0: A2(_elm_lang$html$Html_Attributes$attribute, 'style', 'font-size: 14px;'),
										_1: {ctor: '[]'}
									}
								},
								{
											...
											{ctor: '[]'},
											{
												...
												_0: A2(
													_elm_lang$html$Html$span,
													{
														...
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$title('Mar 20, 2017 - 5:28 AM'),
															_1: {ctor: '[]'}
														}
													},
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('3 minutes ago'),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}),
								...
								_0: A2(
									...
									},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('markdown-render'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												...
												_1: {
													...
													_1: {
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$class('btn btn-primary btn-sm tt'),
																_1: {
																	ctor: '::',
																	_0: A2(_elm_lang$html$Html_Attributes$attribute, 'data-original-title', 'Leave conversation'),
																	_1: {
																		ctor: '::',
																		_0: A2(_elm_lang$html$Html_Attributes$attribute, 'data-placement', 'top'),
																		_1: {
																			ctor: '::',
																			_0: A2(_elm_lang$html$Html_Attributes$attribute, 'data-target', '#confirmModal_modal_leave_conversation_1'),
																			_1: {
																				ctor: '::',
																				_0: A2(_elm_lang$html$Html_Attributes$attribute, 'data-toggle', 'modal'),
																				_1: {
																					ctor: '::',
																					_0: _elm_lang$html$Html_Attributes$href('#'),
																					_1: {
																						ctor: '::',
																						_0: _elm_lang$html$Html_Attributes$id('deleteLinkPost_modal_leave_conversation_1'),
																						_1: {
																							ctor: '::',
																							_0: A2(_elm_lang$html$Html_Attributes$attribute, 'style', ''),
																							_1: {ctor: '[]'}
																						}
																					}
																				}
														...
														_1: {
															...
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$href('/u/abdelrahman/'),
																	_1: {ctor: '[]'}
																},
																{
																	ctor: '::',
																	_0: A2(
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html_Attributes$class('img-rounded tt img_margin'),
																			_1: {
																				ctor: '::',
																				_0: A2(_elm_lang$html$Html_Attributes$attribute, 'data-original-title', 'abdelRahman salah'),
																				_1: {
																					ctor: '::',
																					_0: A2(_elm_lang$html$Html_Attributes$attribute, 'data-placement', 'top'),
																					_1: {
																						...
																						_1: {
																							ctor: '::',
																							_0: A2(_elm_lang$html$Html_Attributes$attribute, 'height', '29'),
																							_1: {
																								ctor: '::',
																								...
																								_1: {
																									...
																									_1: {
																										ctor: '::',
																										_0: A2(_elm_lang$html$Html_Attributes$attribute, 'width', '29'),
																										_1: {ctor: '[]'}
																									}
																								}
																							}
															...
															_1: {
																...
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$href('/u/david1986/'),
																		_1: {ctor: '[]'}
																	},
																	{
																		ctor: '::',
																		_0: A2(
																			_elm_lang$html$Html$img,
																			{
																				...
																				_1: {
																					ctor: '::',
																					_0: A2(_elm_lang$html$Html_Attributes$attribute, 'data-original-title', 'David Roberts'),
																					_1: {
																						ctor: '::',
																						_0: A2(_elm_lang$html$Html_Attributes$attribute, 'data-placement', 'top'),
																						_1: {
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('media-object img-rounded pull-left'),
									_1: {
										ctor: '::',
										_0: A2(_elm_lang$html$Html_Attributes$attribute, 'data-src', 'holder.js/32x32'),
										_1: {
											ctor: '::',
											_0: A2(_elm_lang$html$Html_Attributes$attribute, 'alt', '32x32'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$style(
													{
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('media-body text-break'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Conversations'),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$a,
											_user$project$View$onClickPage(_user$project$Models$NewChatRoomRoute),
											{
												ctor: '::',
												_0: A2(
													_elm_lang$html$Html$i,
